...
--
-- Name: properties fk_properties; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_properties FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
